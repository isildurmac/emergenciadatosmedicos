...
class Registry extends React.Component {
  ...
  constructor(props) {
    ...
    this.showSuccess = this.onSubmit.bind(this);
  }
  onChange = e =>
    this.setState({
  ...
  onSubmit = (e) => {
    e.preventDefault();    
    this.messages.show({ severity: 'success', summary: 'Success Message', detail: 'Registro efectuado' });
    ...
    <section className="section_padding">
      ...
      <Messages ref={(el) => this.messages = el} />
        <form onSubmit={this.onSubmit}>
          ...
          <br />
          <Button label="Aceptar" className="p-button-success" />
        </form>
        <br />
